...
| `fast-sandbox` | fast-sandbox Firecracker runtime: all-in-one control plane (reconcilers + FastPath), sandbox proxy, janitor, node asset installer and runtime-agent. | requires `base`; Firecracker-capable (KVM) nodes |
